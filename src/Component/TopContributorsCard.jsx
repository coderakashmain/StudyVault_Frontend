...
const TopContributorsCard = () => {
  ...
  return (
    ...
    <div className="resizing bg-white! rounded-sm!  w-full ">
            ...
            >
              <div className="flex! items-center! gap-2! sm:gap-3!">
                ...
                <img
                  src={avatarImage}
                  alt={user.full_name}
                  className="w-8! h-8! md:w-10! md:h-10!  sm:w-15! sm:h-15! ml-2!
                             rounded-full! object-cover! text-sm border!"
                />
      ...
      <p className="text-center text-sm text-yellow-600!">Let Participate</p>
