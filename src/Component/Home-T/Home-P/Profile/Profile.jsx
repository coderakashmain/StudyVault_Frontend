          ...
          <div className="upperstyle">
            ...
            <div className="profile-photoes">
              <div className="profile-main-photo-box">
                ...
                <h3>
                  <i class="fa-solid fa-location-dot"></i>MPC AUTO, BARIPADA
                </h3>
              ...
              <p style={{textAlign:'center',paddingTop:'1.2rem',fontSize:'0.7rem',letterSpacing : '0.1rem',fontWeight:'800'}}>ACHE SE PADHO, BACK MAT LAGNE DENA</p>
            ...
            <div className="profile-client-info profilecontain">
              ...
              <div className="forwrap">
                  ...
                  <div className="client-info-name department">
                    ...
                    <div className="client-info-name-inside name-insde">
                      ...
                      <h5>
                        Department<i class="fa-solid fa-arrow-right"></i>
                      </h5>
                    </div>
                  </div>
                  </div>
                  ...
                  <div className="client-info-name gmail">
                    ...
                    <div className="client-info-name-inside name-insde">
                      ...
                      <h5>
                        Gmail<i class="fa-solid fa-arrow-right"></i>
                      </h5>
                    </div>
                  </div>
                ...
                <div className="client-info-name-inside name-insde">
                  <p>BT42-843</p>
                  <h5>
                   Roll No<i class="fa-solid fa-arrow-right"></i>
                  </h5>
                </div>
              </div>
             </div>
              <div className="edit">
               <button>Log out<i class="fa-solid fa-arrow-right-from-bracket"></i></button>
                <button>Edit profile<i class="fa-solid fa-pen-to-square"></i>
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="latest-updates">
             ...
             <div className="latest-updates-files">
              ...
              <div className="files-items">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid officia in.🍫</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid officia in.🍫</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid officia in🍫.</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid officia in🍫.</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid officia in🍫.</p>
